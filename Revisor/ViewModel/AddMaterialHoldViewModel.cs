...
{
    class AddMaterialHoldViewModel : ViewModelBase
    {

        public AddMaterialHoldViewModel(int id,MainWindowViewModel mainWindowViewModel)
        {       Id = id;
            IsEnabled = true;
        ...
        if(ServerRepository.PostHoldMaterial(Id, Name))
            {
                IsEnabled = false;
